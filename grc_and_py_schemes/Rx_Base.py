...
class Rx_Base(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_const=digital.constellation_calcdist((digital.psk_2()[0]), (digital.psk_2()[1]), 2, 1).base(), hdr_dec= fec.dummy_decoder.make(8000), hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0,2)):
        gr.top_block.__init__(self, "Rx_Base", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Rx_Base")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Rx_Base")
        ...
        self.TFMv5_energy_scale_0 = TFMv5.energy_scale(0.924, samp_rate, 12)
...
def main(top_block_cls=Rx_Base, options=None):
    if options is None:
